...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.biometrics.fingerprint@2.1-service.nokia_PLE
LOCAL_INIT_RC := android.hardware.biometrics.fingerprint@2.1-service.nokia_PLE.rc
